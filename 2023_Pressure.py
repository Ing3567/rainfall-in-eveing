...
def plot_pressure_rain_scatter_2023(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average mean sea level pressure and total rainfall for each day of 2023, 
    ...
    # Update plot title to 2023
    plt.title('Pressure (MSL) vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2023', fontsize=16)
...
# Call the new function for 2023
plot_pressure_rain_scatter_2023(file_name)