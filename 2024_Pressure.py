...
def plot_pressure_rain_scatter_2024(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average mean sea level pressure and total rainfall for each day of 2024, 
    ...
    # Update plot title to 2024
    plt.title('Pressure (MSL) vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2024', fontsize=16)
...
# Call the new function for 2024
plot_pressure_rain_scatter_2024(file_name)