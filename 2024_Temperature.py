...
def plot_temp_rain_scatter_2024(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average temperature and total rainfall for each day of 2024, 
    ...
    plt.title('Temperature vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2024', fontsize=16)
...
plot_temp_rain_scatter_2024(file_name)