...
def plot_pressure_rain_scatter_2025(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average mean sea level pressure and total rainfall for each day of 2025, 
    ...
    if df_2025.empty:
        print("No data found for the year 2025 in the file.")
        return
    ...
    if df_filtered_time.empty:
        print("No data found for the 16:00-18:00 time period in 2025.")
        return
    ...
    # Update plot title to 2025
    plt.title('Pressure (MSL) vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2025', fontsize=16)
...
# Call the new function for 2025
plot_pressure_rain_scatter_2025(file_name)