...
def plot_humidity_rain_scatter_2021(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average relative humidity and total rainfall for each day of 2021, 
    ...
    plt.title('Relative Humidity vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2021', fontsize=16)
...
plot_humidity_rain_scatter_2021(file_name)