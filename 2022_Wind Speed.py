...
def plot_wind_rain_scatter_2022(file_path):
    """
    This function creates a scatter plot to show the relationship between 
    average wind speed and total rainfall for each day of 2022, 
    ...
    plt.title('Wind Speed vs. Rain (mm) (Daily Summary 4:00 PM - 6:00 PM) in 2022', fontsize=16)
...
plot_wind_rain_scatter_2022(file_name)